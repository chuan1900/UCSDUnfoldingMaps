...
//		    map = new UnfoldingMap(this, 200, 50, 650, 600, new MBTilesMapProvider(mbTilesString));
	...
	//helper method to test whether a city marker was clicked on
		...
		for(Marker marker : cityMarkers){
			if(!marker.isHidden() && marker.isInside(map, mouseX, mouseY)){
				...
				for(Marker mk : quakeMarkers){
					EarthquakeMarker quakeMarker = (EarthquakeMarker)mk;
					if(marker.getDistanceTo(quakeMarker.getLocation()) 
...
//		}		
	...
	//helper method to test whether a earthquake marker was clicked on
	//and the proper response 
	private void checkQuakeForClick(){
		if (lastClicked != null) return;
		// Loop over the earthquake markers to see if one of them is selected
